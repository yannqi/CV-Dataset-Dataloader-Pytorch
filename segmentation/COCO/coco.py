...
# ImageFile.LOAD_TRUNCATED_IMAGES = True #? 默认跳过损坏图片，但是可能影响训练结果
...
class COCOSegmentation(Dataset):
    def __init__(self, dataset_dir, args, split):
        ...
        ids_file = os.path.join('data/coco_seg/{}_ids_{}.pth'.format(split,2017))
        self.coco_mask = mask
    ...
    def _preprocess(self, ids, ids_file):
        """Remove the objects which are too small. """
